                        ...
                        <div class="post-job">
                            <form id="edit-job-form" action="/j/new" method="post" enctype="multipart/form-data">
                                <div id="vlance_jobbundle_jobtype">
                                    <div class="control-group primary-type">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span10">
                                                ...
                                                <div class="control-group ">
                                                    <label class="required" for="vlance_jobbundle_jobtype_category">Chọn lĩnh vực cần tuyển </label> <select id="vlance_jobbundle_jobtype_category" name="vlance_jobbundle_jobtype[category]" required="required" placeholder="Chọn lĩnh vực phù hợp" data-toggle="popover" data-placement="top" data-content="Chọn lĩnh vực phù hợp" data-trigger="hover" class="popovers-input span12">
                                                        <option disabled="disabled" selected="selected" required="required">- Tên lĩnh vực -</option>
                                    ...
                                    <div class="control-group service_wrapper hidejs">
                                        <label for="vlance_jobbundle_jobtype_service">Chọn dịch vụ phù hợp với yêu cầu tuyển freelancer của bạn nhất </label> <select id="vlance_jobbundle_jobtype_service" name="vlance_jobbundle_jobtype[service]" placeholder="Chọn một dịch vụ cần thuê" data-toggle="popover" data-placement="top" data-content="Chọn một dịch vụ cần thuê" data-trigger="hover" class="popovers-input span12">
                                            ...
                                            <option value="91">Đăng bài lên website / đăng tin rao vặt</option>
                                            <option value="29">Đăng ký / Thay đổi giấy phép đăng ký kinh doanh</option>
                                            <option value="99">Đăng ký quyền sử hữu trí tuệ</option>
                                            <option value="33">Đăng sản phẩm lên website</option>
                                            <option value="167">Đánh giá và kiểm định An toàn thông tin</option>
                                            ...
                                            <option value="215">Lập trình hợp đồng thông minh(Smart Contract)</option>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span10 offset2">
                                                <div class="fileupload_wrapper">
                                                    <a class="addupload" href="#" onclick="return false;" data-toggle="collapse" data-target="#vlance_jobbundle_jobtype_files_file_upload_container">
                                                        Thêm tài liệu đính kèm </a>
                                                    <div class="clear"></div>
                                                    <div id="vlance_jobbundle_jobtype_files" class="control-group fileupload_wrapper ">
                                                    </div>
                                                    <script type="text/javascript">
                                                    ...
                                                    <div id="vlance_jobbundle_jobtype_files_file_upload_container" class="collapse out">
                                                        ...
                                                        <div id="vlance_jobbundle_jobtype_files_collection_holder" id="vlance_jobbundle_jobtype_files" name="vlance_jobbundle_jobtype[files]" data-prototype="&lt;div class=&quot;control-group &quot;&gt;
                                        &lt;div id=&quot;vlance_jobbundle_jobtype_files___name__&quot;&gt;
                                        &lt;div class=&quot;control-group &quot;&gt;
                                        &lt;input type=&quot;file&quot; id=&quot;vlance_jobbundle_jobtype_files___name___file&quot;
                                name=&quot;vlance_jobbundle_jobtype[files][__name__][file]&quot;
                                required=&quot;required&quot; value=&quot;&quot;/&gt;    &lt;/div&gt;    &lt;/div&gt;    &lt;/div&gt;">
                                                        </div>
                                                        <a href="#" class="btn " id="vlance_jobbundle_jobtype_files_job_new_file"><i class="icon-plus"></i> Thêm tài liệu</a>
                                                    </div>
                                                    <script type="text/javascript">
                                                        jQuery(document).ready(function() {
                                                            ...
                                                            if (jQuery('#vlance_jobbundle_jobtype_files')) {
                                                                jQuery('#vlance_jobbundle_jobtype_files_collection_holder').data('index', jQuery('#vlance_jobbundle_jobtype_files input').size());
                                                            } else {
                                                                jQuery('#vlance_jobbundle_jobtype_files_collection_holder').data('index', 0);
                                                            }
                                                            jQuery('#vlance_jobbundle_jobtype_files_job_new_file').click(function(e) {
                                                                add_file_input(jQuery('#vlance_jobbundle_jobtype_files_collection_holder'), '#vlance_jobbundle_jobtype_files');
                                                                e.preventDefault();
                                                            });

                                                            if (required_one) {
                                                                jQuery('#vlance_jobbundle_jobtype_files_file_upload_container').collapse('show');
                                                                add_file_input(jQuery('#vlance_jobbundle_jobtype_files_collection_holder'), '#vlance_jobbundle_jobtype_files');
                                                            }
                                                        });
                                                    </script>
                                    ...
                                    <div class="control-group">
                                        <div class="row-fluid">
                                            <div class="span5 offset2 job-closed-at">
                                                <div class="control-group ">
                                                    <label class="required" for="vlance_jobbundle_jobtype_onsiteLocation">Hình thức làm việc </label> <select id="vlance_jobbundle_jobtype_onsiteLocation" name="vlance_jobbundle_jobtype[onsiteLocation]" required="required" pattern="[0-9]*" placeholder="ví dụ: 14" class="row-fluid span12">
                                                        <option value="2">Làm online</option>
                                                        <option value="0" selected="selected">Làm tại văn phòng</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="control-group primary-type">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span10">
                                                <h4>Yêu cầu khác với freelancer</h4>
                                                <div class="row-fluid">
                                                    <div class="span6 job-fl-city">
                                                        <div class="control-group ">
                                                            <label class="required" for="vlance_jobbundle_jobtype_city">Cần tuyển freelancer làm việc tại </label> <select id="vlance_jobbundle_jobtype_city" name="vlance_jobbundle_jobtype[city]" required="required" data-toggle="popover" data-placement="top" data-content="Chọn vị trí của freelancer, VD: Hà Nội" data-trigger="hover" class="popovers-input span12">
                                                                <option disabled="disabled" selected="selected">- Nơi cần thuê -</option>
