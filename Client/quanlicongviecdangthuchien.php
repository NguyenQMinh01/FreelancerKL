...
<body class="one-column job_draft_workspace ">
        ...
        <div class="main_content content-fix">
                            ...
                            <div class="span12 news-client-view" style="border-radius: 5px;min-height: 450px">
                                <table class="table datatable" style="margin-top: 50px;">
                                    <thead class="head-title-tb display-desktop-workspace">
                                        <th class="project-freelancer" style="padding-top: 15px;padding-bottom: 15px;">Công việc</th>
                                       

                                        <th class="payment-th" style="padding-top: 15px;padding-bottom: 15px;padding-right: 100px;">Hạn chót </th>
            ...
            <!-- <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#not-suggest-upgrade-pro-1').click(function() {
                        $('#suggest-link').hide();
                        $('#suggest-detail').hide();
                        $('#close-modal-pro').show();
                    });

                    $('#not-suggest-upgrade-pro-2').click(function() {
                        $('#suggest-link').hide();
                        $('#suggest-detail').hide();
                        $('#close-modal-pro').show();
                    });
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    if ($(window).width() > 639) {
                        $('.push-top-button button').popover({
                            trigger: "hover"
                        });
                    };
                });
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    url: 'https://job.ahlupos.com/modules/job/api.php?ac=job_client_doing',
                    data:data,
                    method: 'POST',
                    success: function(res) {
                        ...
                        a.map((v, i) => {
                            s += `<tr class="odd updated draft-job63948">
                                           ...
                                           <a class="viewdetail" data-id=${v.id_job} >xem chi tiết</a>  </td>
                ...
                $(document).delegate('a.viewdetail','click',function(){
                    ...
                    window.location.href = "/Client/qlcvdetail.php";
                })
     });
    </script>           
</body>
