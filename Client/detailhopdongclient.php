        ...
        <div id="jobsearch-Main" style = "padding-top: -100px;"><span id="m-gnav-header"><span>
                    <div class="jobsearch-SerpMainContent " style="margin-bottom: 100px;" style="padding-top: 600px;">
                        <div class="jobsearch-LeftPane">
                            ...
                            <div class="jobsearch-RelatedSearchList"><b class="jobsearch-RelatedSearchList-title">Career Resources: </b><a href="/career/salaries?from=jobsearch_footer">Career Explorer</a> - <a href="/career/salary-calculator?from=jobsearch_footer">Salary Calculator</a></div>
                            <div class="jobsearch-RelatedSearchList"><b class="jobsearch-RelatedSearchList-title">Employer Resources: </b><a href="/hire/how-to-write-a-job-description?from=jobsearch_footer">How to Write a Job Description</a> - <a href="/hire/how-to-hire?from=jobsearch_footer">How to Hire Employees</a></div>
                                                            ...
                                                            <div class="jobsearch-JobComponent icl-u-xs-mt--sm jobsearch-JobComponent--embedded" style="height: 902px;">
                                                                ...
                                                                <div class="jobsearch-JobComponent-embeddedBody" style="overscroll-behavior-y: auto;">
                                                                    ...
                                                                    <div class="jobsearch-JobTab-content">
                                                                        <div id="belowJobDescription" class="mosaic mosaic-empty-zone"></div>
                                                                        <div class="jobsearch-JobMetadataFooter">
                                                                            <div class="icl-u-textColor--success">.</div>
                                                                            <div class="mosaic mosaic-provider-reportcontent mosaic-provider-hydrated" id="mosaic-provider-reportcontent">
                                                                                <div class="mosaic-reportcontent-wrapper button"><button class="mosaic-reportcontent-button desktop css-1686x4 e8ju0x51"><span class="mosaic-reportcontent-button-icon"></span>Đánh giá</button>
