...
<head>
    ...
    <title>Freelancer Việt Nam - Lựa chọn số 1 của doanh nghiệp vn</title>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <header class="jumbotron-new carousel-subhead_2">
                                <div class="container">
                                    <div class="jumbotron-new-even">
                                        <h1 class="lh8 mp-lh6"><b style = "color: rgba(0,147,208,1)">Nơi tìm việc chất lượng đảm</b>  bảo thêm thu nhập </h1>
                                        <div class="jumbotron-button">
                ...
                <div class="list-job-homepage">
                    ...
                    <div class="reviews-section">
                        ...
                        <div class="review-media">
                            ...
                            <h1 class="lh2" style = "text-align: center;">Trang web được vinh danh trong cộng đồng freelancer</h1></div>
