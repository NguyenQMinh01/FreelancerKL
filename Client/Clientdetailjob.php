...
<head>
    ...
    <script type="text/javascript" src="https://www.vlance.vn/js/vlance_datepicker.min.jshttps://www.vlance.vn/js/vlance_datepicker.min.js" defer></script>
    ...
    <script type="text/javascript" src="https://www.vlance.vn/js/form/vlance_validate.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/form/validate.inputfile.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/form/bid.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/form/job.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/skill/tagmanager.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/form/credit/spend.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/validator/validate.contact.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/form/workroom.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/thuengay/reconfirm_email.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/star_rating/jquery.form.min.js?v=20221103.1449"></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/star_rating/jquery.rating.min.js?v=20221103.1449"></script>

</head>

<body class="one-column job_show job_show_parttime_job ">
    <div class="main">
        <div id="fb-root"></div>
                ...
                <div class="wrap-mobile login wrap-mobile-ver2 ver2">
                    <ul class="accordion-menu-dropdown nav-menu-mobile ver2">
                        ...
                        <li class="menu-mobile-item ver2 img-500k">
                            ...
                            <a style="width: 100px; height: 29px" href="/a/moi-ban-be" onclick="vtrack('Click invite', {'location':'job_show_parttime_job'})">
        ...
        <div class="main_content">
                                ...
                                <div class="body-view hidebody">
                                    <div class="row-fluid">
                                        <div class="service-need-hire">
                                            <div class="service-title">
                                                Dịch vụ cần thuê:
                                                <a href="/viec-lam-freelance/dichvu_lap-trinh-web-golang">
                                                    <b>
                                                        Lập tr&igrave;nh web Golang </b>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row-fluid textbody">
                                        <div class="description">
                                            <p>Giao diện web gồm: trang chủ, th&ocirc;ng tin sản phẩm , danh s&aacute;ch sản phẩm, th&ocirc;ng tin chi tiết sản phẩm , đăng nhập đăng k&iacute; t&agrave;i khoản , giỏ h&agrave;ng , thanh to&aacute;n</p>
                                        </div>
                                        <div class="skill">
                                            <label>Kỹ năng:</label>
                                            <div class="list-skill">
                                                <a title="Lập tr&igrave;nh web"> Lập tr&igrave;nh web,</a>
                                                <a title="Lập tr&igrave;nh C#"> Lập tr&igrave;nh C#,</a>
                                                <a title="Web design"> Web design,</a>
                                                <a title="Golang"> Golang,</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="description-job">
                                            <dl class="dl-horizontal">
                                                ...
                                                <dd>63948</dd>
                                                <dt>Địa điểm</dt>
                                                <dd>TP. Hồ Ch&iacute; Minh</dd>
                                                <dt>Ngân sách</dt>
                                                <dd>
                                                    200.000đ - 1.000.000đ </dd>
                                    ...
                                    <div class="info-employment">
                                        <div class="info-employment-top row-fluid">
                                            ...
                                            <div class="span8">
                                                ...
                                                <div class="work-title">developer</div>
                                                <div id="client-rating-box">
                                                    <div class="box-rating-client" data-toggle="popover" data-placement="right" data-content="<div>Tiền đã thuê : <b>0</b> VNĐ</div> <div>Việc đã đăng : <b>0</b> việc </div><div>Việc đã giao : <b>0</b> việc</div>" data-trigger="hover" data-html="true">
                ...
                <div class="client-view-bid span12">
                    ...
                    <div class="row-fluid container list-bid-new" style="margin-bottom: 30px; width: 96%; max-width: 1200px">
                        <div class="no-profile-job">
                            Hiện tại công việc này chưa có ai chào giá. </div>
                    </div>
            ...
            <div class="modal fade popup-history-push-top" id="popup-history-renew" role="dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row-fluid text-center push-success">
                                ...
                                <div class="noti">
                                    Lưu lại các lần làm mới của dự án này
                                </div>
                            </div>
            ...
            <div class="modal fade popup-push-success" id="popup-buy-credit" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row-fluid text-center push-success">
                                ...
                                <div class="description">
                                    Cần 10 credit để làm mới ngay </div>
                                <a href="/credit/balance-client" class="btn btn-size btn-show-job btn-vl-green">
                                    Mua thêm credit </a>
                            </div>
                        </div>
                    </div>
