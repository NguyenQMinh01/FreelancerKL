            ...
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: calc(-70px + 100vh);">
                <div class="navbar-content scroll-div" style="overflow: hidden; width: 100%; height: calc(-70px + 100vh);">
                    <ul class="nav pcoded-inner-navbar">
                        ...
                        <li data-username="List Contract" class="nav-item active"><a href="listcontract.php" class="nav-link"> <span class="pcoded-micon"><i class="feather icon-user"></i></span> <span class="pcoded-mtext">Danh sách hợp đồng</span></a> </li>
