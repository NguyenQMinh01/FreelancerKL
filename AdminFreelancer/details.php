            ...
            <div class="container">
                <div class="row mt-10">
                    <div class="col-lg-8 col-md-12">
                        <h3>Lập trình web bán giày</h3>
                        <div class="mt-0 mb-15"><span class="card-briefcase">Đã duyệt</span><span class="card-time">3 mins ago</span></div>
                    </div>
                        ...
                        <div class="job-overview">
                            ...
                            <div class="row mt-25">
                                <div class="col-md-6 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10"><span class="text-description jobtype-icon mb-10">ID Job</span><strong class="small-heading">1132</strong></div>
                                </div>
                            </div>
                            <div class="row mt-25">
                                <div class="col-md-6 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10"><span class="text-description salary-icon mb-10">Ngân sách</span><strong class="small-heading">$800 - $1000</strong></div>
                                </div>
                            </div>
                            <div class="row mt-25">
                                <div class="col-md-6 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10"><span class="text-description mb-10">Hạn chào giá</span><strong class="small-heading">10/02/2022</strong></div>
                                </div>
                            </div>
                            <div class="row mt-25">
                                <div class="col-md-6 d-flex mt-sm-15">
                                    <div class="sidebar-icon-item"><img src="http://wp.alithemes.com/html/jobbox/demos/assets/imgs/page/job-single/updated.svg" alt="jobBox"></div>
                                    <div class="sidebar-text-info ml-10"><span class="text-description jobtype-icon mb-10">Ngày được duyệt</span><strong class="small-heading">10/01/2022</strong></div>
                                </div>
                            </div>
                        </div>
                        <div class="content-single">
                            <h4>Thông tin tuyển dụng</h4>
                            <p>TGiao diện web gồm: trang chủ, thông tin sản phẩm , danh sách sản phẩm, thông tin chi tiết sản phẩm , đăng nhập đăng kí tài khoản , giỏ hàng , thanh toán</p>
                        ...
                        <div class="sidebar-border">
                            <div class="sidebar-heading">
                                <div class="avatar-sidebar">
                                    ...
                                    <div class="sidebar-info"><span class="sidebar-company">Minh</span><span class="card-location">New York, US</span><a class="link-underline mt-15" href="#">Developer</a></div>
                                </div>
                            </div>
