...
<head>
    <link rel="canonical" href="https://appseed.us/product/datta-able/flask/">
    <meta name="google-site-verification" content="kCT200-J0rfczENRkJQdYCqsDKkUo3Hvr3KZic_otwU">
    <title>Admin - Dashboard | Freelancer</title>
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: 'https://job.ahlupos.com/modules/job/api.php?ac=total_admin',
                success: function(res) {
                    var s = "";
                    let a = JSON.parse(res);
                    let total = parseInt(a.total_client,10);
                    let total1 = parseInt(a.total_freelancer,10);
                    let b = total+total1;
                    //alert(b);
                        s += `<div class="card-block border-bottom">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto"> <i class="feather icon-zap f-30 text-c-green"></i> </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">${a.total_post}</h3> <span class="d-block text-uppercase">Dự án đã được xét duyệt</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block  border-bottom">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto"> <i class="feather icon-map-pin f-30 text-c-blue"></i> </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">${b}</h3> <span class="d-block text-uppercase">Sô lượng tài khoản đăng kí và truy cập</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block  border-bottom">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto"> <i class="feather icon-map-pin f-30 text-c-blue"></i> </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">${total}</h3> <span class="d-block text-uppercase"> nhà tuyển dụng </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block  border-bottom">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto"> <i class="feather icon-map-pin f-30 text-c-blue"></i> </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">${total1}</h3> <span class="d-block text-uppercase">lập trình viên</span>
                                                </div>
                                            </div>
                                        </div>`;
