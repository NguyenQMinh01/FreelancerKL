                                    ...
                                    <form id="submit_bid_form" action="/bid/create/63797" method="post" enctype="multipart/form-data" data-display-track="show-bid-form-bidable">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span7">
                                                ...
                                                <div class="row-fluid">
                                                    <label class="ques-text">Bạn có những kinh nghiệm và kỹ năng nào phù hợp với dự án này? ,dự định thực hiện dự án này như thế nào?<span class="text-red">*</span></label>
