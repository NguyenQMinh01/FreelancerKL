                    ...
                    <div class="menu-inner">
                        <ul class="menu-inner-list">
                            <li class="menu-item first ver2 ">
                                <a title="Thuê Freelancer">Thuê Freelancer<span class="caret"></span></a>
                                                ...
                                                <li class="menu-dropdown-content-item">
                                                    ...
                                                    <ul class="content-item-detail">
                                                        <li class="menu-dropdown-item-content">
                                                            <a>Đăng tin nhận báo giá <i class="" aria-hidden="true" style="margin-left:50px;color:black"></i></a>
                                                        </li>
                                                        <li role="presentation"><a role="menuitem" tabindex="-1" onclick="vtrack('Click freelancer list page', {'position':'Homepage'})">Tìm
                    ...
                    <div class="pull-right nav-account sec-account-menu ver2">
                        ...
                        <div class="account-menu pull-right">
                            <div class="avata avata_ver2">
                                <a>
                                    <img class="avt" width="48" height="48" src="https://www.vlance.vn/uploads/48x48/5137679a253a06555c594a9df5f13502041e06931.png" alt="avt" title="avt" />
                                </a>
                            </div>
                            <div class="dropdown">
                    ...
                    <li class="tf200 first ">
                        <div class="dropdown manage-user">
                            ...
                            <ul class="dropdown-menu" style="min-width:200px">
                                <li style="margin-bottom:20px"><a href="/Freelancer/quanliviec.php" onclick="vtrack('Click view workroom FL', {'position':'menu header'})">Quảnlý việc đang báo giá</a></li>
    ...
    <div class="navbar navbar-static-top nav-new display-mobile ver2">
        ...
        <div class="overlay-block overlay-left login ver2" style="height: 800px;display: none">
            ...
            <div class="post-button-ver2">
                <a class="btn btn-vl btn-vl-green btn-vl-medium" onclick="vtrack('Click post job', {'position':'Homepage'})" href="/Client/dangduan.php">Đăng dự
                    án</a>
            </div>
        </div>
    </div>
                                        ...
                                        <hx:include evaljs="true" src="/block/client-job-working/minh-nguyen-1130" class="included include_200">
                                            <div class="row-fluid block_jobs block-suggest-freelancers block-all-jobs block-job-client" style="padding-bottom: 0">
                                                <h2 class="suggest-freelancer-title" style="margin: 0">Tất cả công việc
                                                    của Minh</h2>
                                                <div class="row-fluid">
                                                    <div class="row-fluid job-list job-working jobs-account slide-job-finish-client">
                                                        <h2 class="block-tilte_jobs" style="margin-top: 23px;margin-bottom: -20px">Đang tuyển
                                                        ...
                                                        <div class="slide-job-working slick-initialized slick-slider">
                                                            ...
                                                            <div aria-live="polite" class="slick-list draggable">
                                                                <div class="slick-track" role="listbox" style="opacity: 1; width: 35604px; left: -34830px;">
                                                                    <div class="sublist-item slick-slide" data-slick-index="44" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide044" style="width: 774px;">
                                                                        <div style="margin-bottom: 15px;" class="job-item-client">
                                                                            <div class="row-fluid">
                                                                                <div class="job-comment span12">
                                                                                    <h3 class="title-job-client title">
                                                                                        <a href="/viec-freelance/can-tuyen-nguoi-co-the-ho-tro-seo-website" tabindex="-1">Cần tuyển
                                                                                ...
                                                                                <div class="span12" style="margin: 0;padding-left: 20px">
                                                                                    ...
                                                                                    <div class="price span3 price-day-job price-job color-dark-profile">
                                                                                        500.000 - 1.000.000 VNĐ </div>
                                                                                </div>
                                                                                <span class="information-bottom-left color-dark-profile">
                                                                                    6 chào giá </span>
                                                                                <span class="price-day-job color-blur-profile">Đã
                                                                                    hết hạn chào giá</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="sublist-item slick-slide slick-current slick-active" data-slick-index="45" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide045" style="width: 774px;">
                                                                        <div style="margin-bottom: 15px;" class="job-item-client">
                                                                            <div class="row-fluid">
                                                                                <div class="job-comment span12">
                                                                                    <h3 class="title-job-client title">
                                                                                        <a href="/viec-freelance/tro-ly-seo-co-kien-thuc-sau-ve-ahrefs-so-huu-nhieu-tu-khoa-len-top-de-ho-tro-seo-website" tabindex="0">Tuyển người có
                                                                                ...
                                                                                <span class="information-bottom-left color-dark-profile">
                                                                                    1 chào giá </span>
                                                                                <span class="price-day-job color-blur-profile">
                                                                                    <span> Ngày hết hạn:</span>
                                                                                    <span class="color-dark-profile">09/02/2023</span>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <button type="button" data-role="none" class="slick-next slick-arrow slick-disabled" aria-label="Next" role="button" style="display: block;" aria-disabled="true">Next</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row-fluid">
                                                    <div class="row-fluid job-list job-working jobs-account">
                                                        <h2 class="block-tilte_jobs" style="margin-top: 23px;margin-bottom: -20px">Việc đã đăng
                                                                            ...
                                                                            <div class="row-fluid">
                                                                                <div class="job-comment span12">
                                                                                    <h3 style="font-size: 16px;color: #0088CC;margin-bottom: -5px" class="title-job-client title">
                                                                                        <a href="/Client/Clientdetailjob.php" tabindex="0">TUYỂN
                                                                                        ...
                                                                                        <div class="span9">
                                                                                            <div>
                                                                                                ...
                                                                                                <div class="client-name" style="margin-top: 8px">
                                                                                                    ...
                                                                                                    <span style="margin-left: 5px">Nguyễn
                                                                                                        Minh</span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                    ...
                                                                    <div class="sublist-item slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide01" style="width: 698px;">
                                                                        <div class="job-item-client">
                                                                            <div class="row-fluid">
                                                                                <div class="job-comment span12">
                                                                                    <h3 style="font-size: 16px;color: #0088CC;margin-bottom: -5px" class="title-job-client title">
                                                                                        <a href="/Client/Clientdetailjob.php" tabindex="-1">TUYỂN CTV
                        ...
                        <div class="summary-profile contact-direct contact-mobile">
                            ...
                            <div class="list-summary-profile row-fluid">
                                ...
                                <dl class="dl-horizontal span7 detail-contact-client">
                                    <dd><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="600d090e080d0f0e51515252535320070d01090c4e030f0d">minhmon112233@gmail.com</a>
                                    </dd>
                                </dl>
                            </div>
                            <div class="list-summary-profile row-fluid">
