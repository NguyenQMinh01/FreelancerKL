...
<head>
    ...
    <meta property="og:image"
        content="https://www.vlance.vn/uploads/300x300/5137679a253a06555c594a9df5f13502041e06931.png" />
    <meta property="og:image:width" content="300" />
    <meta property="og:image:height" content="300" />
    <meta property="og:description" itemprop="description" name="description"
        content="Freelancer M&iacute;nh c&oacute; kinh nghiệm trong lĩnh vực Lập tr&igrave;nh web đến từ H&agrave; Nội. t&ocirc;i l&agrave; freelancer" />
    ...
    <link href="https://www.vlance.vn/css/gui/account/profile.css?v=20221103.1449" rel="stylesheet" type="text/css"
        media="all" />
    ...
    <script type="text/javascript" src="https://www.vlance.vn/js/skill/tagmanager.min.js?v=20221103.1449" defer>
    </script>
                                        ...
                                        <div class="container visitor">
                                            <ul class="menu-dropdown-content">
                                                    ...
                                                    <a href="#">
                                                        <div class="content-item-block">
                                                            <div class="block-text">
                                                                ...
                                                                <span class="block-text-subtitle">Hàng ngàn công việc
                                                                    mới được đăng mỗi ngày</span>
                                                            </div>
                                                ...
                                                <li class="menu-dropdown-content-item">
                                                        ...
                                                        <div class="content-item-block">
                                                            <div class="block-text">
                                                                <strong class="block-text-title">Đăng hồ sơ năng
                                                                    lực</strong>
                                                                <span class="block-text-subtitle">Để khách hàng có thể
                                                                    chủ động liên hệ với bạn</span>
                                                            </div>
                                                            <div class="block-icon"><i class="fa fa-chevron-right"
                                                                    aria-hidden="true"></i></div>
                                                        </div>
                                                    ...
                                                    <ul class="content-item-detail">
                                                        <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                href="#">Hồ sơ freelancer</a></li>
                                                        <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                href="#">Sản phẩm đã làm</a></li>
                ...
                <ul class="nav-menu span12">
                    <li class="tf200 ">
                        <div class="dropdown manage-user">
                            <a data-toggle="dropdown"> Quản lý cho freelancer <i class="fa fa-angle-down"
                ...
                <ul class="accordion-menu-dropdown nav-menu-mobile ver2">
                        ...
                        <ul class="submenu-list-ver2 accordion-menu-dropdown ">
                            <li class="submenu-item-ver2 accordion-chevron">
                                <a class="submenu-link-ver2 accordion-toggle-ver2 ver2"
                                    href="/Freelancer/quanliviec.php">Quản lý việc nhận làm<i class="fa fa-angle-down"
                                        aria-hidden="true"></i></a>
                    ...
                    <li class="accordion-chevron menu-mobile-item ver2">
                        ...
                        <ul class="submenu-list-ver2 accordion-menu-dropdown">
                            ...
                            <li class="submenu-item-ver2 accordion-chevron">
                                <a class=" submenu-link-ver2 accordion-toggle-ver2 ver2" href="">Đăng hồ sơ năng lực<i
                                        class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul class="accordion-inner-ver2">
                                    <li class="ver2">
                                        <a role="menuitem" tabindex="-1" href="/Freelancer/profilefreelancer.php">Hồ sơ
                                            freelancer</a>
                                    </li>
                                    <li class="ver2">
                                        <a role="menuitem" tabindex="-1" href="/Freelancer/profilefreelancer.php">Sản
                                            phẩm đã làm</a>
                                    </li>
                    ...
                    <div id="main_content">
                        <div style="display: none;">
                            <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                    › <a href="/freelancers/cpath_cac-cong-viec-it-va-lap-trinh_chash_lap-trinh-web"
                                        itemprop="item">
                        ...
                        <div class="row-fluid right-content-fl" itemscope itemtype="http://data-vocabulary.org/Person">
                            <div class="col3-left span4 left-profile avata-m">
                                <div class="avata">
                                    <div class="update-link tf300"><a class="tf300" href="#">Thay hình đại diện</a>
                                    </div>
                                    <img class="avt" itemprop="photo" src="/img/hero-bg.png" alt="M&iacute;nh"
                                        title="M&iacute;nh" />
                                </div>
                                <div class="id_profile id-user">
                                    id. 1250511 </div>
                            </div>
                                    ...
                                    <div class="span12 fr-name-info">
                                        <h1 style="float: left">
                                            <span itemprop="name">
                                                ...
                                                <span class="update-profile-link tf200">
                                                    <a class="btn btn-update info-fr" style="background-color: #23c3eb"
                                                        href="/Freelancer/editprofilefreelancer.php">Cập nhật thông
                                                        tin</a>
                                                </span>
                                            </span>
                                        </h1>
                                        ...
                                        <div class="regional-price">
                                            ...
                                            <span itemprop="address" itemscope
                                                ...
                                                <span style="color: #999999" class="location editable tf300"
                                                    itemprop="region">
                                                    H&agrave; Nội </span>
                                            </span>
                                        </div>
                            ...
                            <div class="tab-content profile-content">
                                <div class="active tab-pane" id="tong-quan"
                                    ...
                                    <div class="overview overview-mobile" style="width:50%;margin-right:20px">
                                ...
                                <hx:include evaljs="true" src="/" class="included include_200">
                                    <div class="row-fluid block_jobs block-suggest-freelancers block-all-jobs"
                                        style="padding-bottom: 0">
                                        <h2 class="suggest-freelancer-title" style="margin: 0">Tất cả công việc của Minh
                                        </h2>
                                        <div class="row-fluid">
                                            <div class="row-fluid job-list job-working jobs-account">
                                                <h2 class="block-tilte_jobs">Việc đang làm <span class="job-count-new">
                                                        1</span></h2>
                                                <div class="slide-job-working slick-initialized slick-slider">
                                                    <div aria-live="polite" class="slick-list draggable">
                                                        <div class="slick-track" role="listbox"
                                                            style="opacity: 1; width: 743px; left: 0px;">
                                                            <div class="sublist-item slick-slide slick-current slick-active"
                                                                ...
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                            ...
                                                                            <div class="fr-title span9">
                                                                                <span>
                                                                                    <img style="display: inline"
                                                                                        src="/media/internal-link/location.png">
                                                                                </span>
                                                                        ...
                                                                        <div class="span12"
                                                                            ...
                                                                            <div
                                                                                class="feedback-job span12 block-no-review">
                                                                                <div class="span9">
                                                                                    <span
                                                                                        style="color: #999999;margin-left: -20px;">Chưa
                                                                                        có nhận xét nào</span>
                                                                                </div>
                                                                                <div class="span3">
                                                                                </div>
                                                                            </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="row-fluid job-list job-finished jobs-account">
                                                <h2 class="block-tilte_jobs">Việc hoàn thành <span
                                                        class="job-count-new">20</span></h2>
                                                <div class="slide-job-finished slick-initialized slick-slider"><button
                                                    ...
                                                    <div aria-live="polite" class="slick-list draggable">
                                                        <div class="slick-track"
                                                            style="opacity: 1; width: 14860px; left: 0px;"
                                                            role="listbox">

                                                            <div class="sublist-item slick-slide" data-slick-index="1"
                                                                aria-hidden="true" tabindex="-1" role="option"
                                                                aria-describedby="slick-slide21" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php"
                                                                                    tabindex="-1">Chỉnh css cho
                                                                                    website</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12"
                                                                        ...
                                                                        <div class="span12"
                                                                            style="padding: 0 20px;margin: 0">
                                                                            <div
                                                                                class="feedback-job span12 block-review">
                                                                                <div class="span9">
                                                                                    <div>
                                                                                        <div
                                                                                            class="comment comment-three comment-fd-2620">
                                                                                            <div class="ds">Mình rất hài
                                                                                                lòng với cách làm việc
                                                                                                của bạn. Bạn làm đúng
                                                                                                deadline và hỗ trợ,
                                                                                                support nhiệt tình.
                                                                                                Khi có việc mới, chắc
                                                                                                chắn mình sẽ chọn bạn.
                                                                                                Cảm ơn bạn.</div>
                                                                                        </div>
                                                                                        <div class="client-name"
                                                                                            style="margin-top: 8px">
                                                                                            <span>
                                                                                                <a href="/khach-hang/tran-huu-hieu-2"
                                                                                                    tabindex="-1">
                                                                                                    <img style="display: inline-block"
                                                                                                        class="client-pic"
                                                                                                        itemprop="photo"
                                                                                                        src="https://www.vlance.vn/uploads/24x24/1d26b931df1e55dba0cd542d39a924d1ad2f9b6c.jpeg1.jpg"
                                                                                                        alt="Trần Hữu Hiếu"
                                                                                                        title="Trần Hữu Hiếu">
                                                                                                </a>
                                                                                            </span>
                                                                                            <span
                                                                                                style="margin-left: 5px">Trần
                                                                                                Hữu Hiếu</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="span3">
                                                                                    <span class="rating_pf">
                                                                                        <div class="rating-box num_star_rating"
                                                                                            style="float:right"
                                                                                            data-toggle="popover"
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="5"
                                                                aria-hidden="true" tabindex="-1" role="option"
                                                                aria-describedby="slick-slide25" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php"
                                                                                    tabindex="-1">Chỉnh sửa báo cáo</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12"
                                                                            style="margin: 0;padding-left: 20px">
                                                                        ...
                                                                        <div class="span12"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="span9">
                                                                                    <div>
                                                                                        <div
                                                                                            class="comment comment-three comment-fd-2445">
                                                                                            <div class="ds">Tương tác
                                                                                                không phù hợp</div>
                                                                                        </div>
                                                                                        <div class="client-name"
                                                                                            style="margin-top: 8px">
                                                                                            <span>
                                                                                                <a href="/khach-hang/steven-cao"
                                                                                                    tabindex="-1">
                                                                                                    <img style="display: inline-block"
                                                                                                        class="client-pic"
                                                                                                        itemprop="photo"
                                                                                                        src="https://www.vlance.vn/uploads/24x24/7e48f97ce768bf36d9c0075a60c0b4272f8e965e1.png"
                                                                                                        alt="Steven Cao"
                                                                                                        title="Steven Cao">
                                                                                                </a>
                                                                                            </span>
                                                                                            <span
                                                                                                style="margin-left: 5px">Steven
                                                                                                Cao</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="6"
                                                                aria-hidden="true" tabindex="-1" role="option"
                                                                aria-describedby="slick-slide26" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php"
                                                                                    tabindex="-1">Cài đặt Windows VPS và
                                                                                    cài phần mềm k�...</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12"
                                        ...
                                        <div class="row-fluid">
                                            <div class="row-fluid job-list job-canceled jobs-account">
                                                <h2 class="block-tilte_jobs">Việc đã hủy <span
                                                        class="job-count-new">4</span></h2>
                                                <div class="slide-job-canceled slick-initialized slick-slider"><button
                                                        type="button" data-role="none"
                                                        class="slick-prev slick-arrow slick-disabled"
                                                        aria-label="Previous" role="button" aria-disabled="true"
                                                        style="display: block;">Previous</button>
                                                    <div aria-live="polite" class="slick-list draggable">
                                                        <div class="slick-track"
                                                            style="opacity: 1; width: 2972px; left: 0px;"
                                                            role="listbox">
                                                            <div class="sublist-item slick-slide slick-current slick-active"
                                                                data-slick-index="0" aria-hidden="false" tabindex="-1"
                                                                ...
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php"
                                                                                    tabindex="0">Fix và bổ sung thêm
                                                                                    tính năng cho website s...</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12"
                                                                            style="margin: 0;padding-left: 20px">
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="1"
                                                                aria-hidden="true" tabindex="-1" role="option"
                                                                aria-describedby="slick-slide31" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/viec-freelance/lap-trinh-front-end-cho-asp-net-webform-voi-html-jquery-va-bootstrap"
                                                                                    tabindex="-1">Lập trình front end
                                                                                    cho asp.net webform với ...</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12"
                                                                            style="margin: 0;padding-left: 20px">
                            ...
                            <div class="block-internal-link">
                                <div class="row-fluid">
                                    <div class="span6 il-item il-item-full" onclick="location.href='/';"
                                        style="cursor: pointer;">
                                        <span class="span3" style="padding-top: 12px">
                                            <img style="width:64px; height:64px;"
                                                src="/img/internal_link_profile_client_1.png">
                                        </span>
                                        <span class="il-title span7" style="padding-top: 0">
                                            <a class="il-link-client" href="/Client/searchfreelancer.php">Kết nối uy
                                                tín</a>
                                            <p class="il-content">freelancer.vn là trang kết nối Freelancer và Khách
                                                hàng uy tín</p>
                                        </span>
                                    ...
                                    <div class="span6 il-item il-item-2 il-item-full"
                                        onclick="location.href='/viec-lam-freelance';" style="cursor: pointer;">
                                        <span class="span3" style="padding-top: 12px">
                                            <img style="width:64px; height:64px;"
                                                src="/img/internal_link_profile_client_2.png">
                                        </span>
                                        <span class="il-title span7" style="padding-top: 0">
                                            <a class="il-link-client" href="#">Xem việc mới</a>
                                            <p class="il-content">Xem các việc mới để bắt đầu làm online ngay bây giờ
                                            </p>
                                        </span>
                                        <span class="il-arrow span2" style="padding-top: 31px">
                                            <img style="float: right" src="/img/internal_link_profile_client_3.png">
                    ...
                    <div class="summary-profile contact-direct contact-mobile">
                        ...
                        <div class="list-summary-profile row-fluid">
                            ...
                            <dl class="dl-horizontal span7">
                                <dd><a  class="__cf_email__"
                                        data-cfemail="2f424641474240411e1e1d1d1c1c6f48424e4643014c4042">minhmon112233@gmail.com</a>
                                </dd>
                            </dl>
                        </div>
                        <div class="list-summary-profile row-fluid">
                                ...
                                <dl class="dl-horizontal span7">
                                    ...
                                    <dd>
                                        <div class="rating-box num_star_rating" data-toggle="popover"
                                            data-placement="right" data-content="4,40" data-trigger="hover"
