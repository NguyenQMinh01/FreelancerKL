                        ...
                        <div class="account-menu pull-right">
                            <div class="avata avata_ver2">
                                <a href="/Freelancer/yourprofile.php">
                                    <img class="avt" width="48" height="48" src="https://www.vlance.vn/uploads/48x48/5137679a253a06555c594a9df5f13502041e06931.png" alt="M&iacute;nh" title="M&iacute;nh" />
                                </a>
                            </div>
                            <div class="dropdown">
                    ...
                    <li class="tf200 ">
                        <div class="dropdown manage-user">
                            ...
                            <ul class="dropdown-menu" style="min-width:200px">
                                <li style="margin-bottom:20px"><a href="/Freelancer/quanliviec.php" onclick="vtrack('Click view workroom FL', {'position':'menu header'})">Quản lý
                                        việc nhận làm</a></li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div class="row-fluid right-content-fl" itemscope itemtype="http://data-vocabulary.org/Person">
                            <div class="col3-left span4 left-profile avata-m">
                                <div class="avata">
                                    ...
                                    <img class="avt" itemprop="photo" src="/img/hero-bg.png" alt="M&iacute;nh" title="M&iacute;nh" />
                                </div>
                                        ...
                                        <h1 style="float: left">
                                            <span itemprop="name">
                                                ...
                                                <span class="update-profile-link tf200">
                                                    <a class="btn btn-update info-fr" style="background-color: #23c3eb" href="/Freelancer/editprofilefreelancer.php">Cập nhật thông
                                                        tin</a>
                                                </span>
                                            </span>
                                        </h1>
                                                                ...
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php" tabindex="0">Thiết kế website -
                                                                                    dashboard</a>
                                                                            </h3>
                                                                        </div>
                                                                        ...
                                                                        <div class="span12" style="padding: 0 20px;margin: 0">
                                                                            <div class="feedback-job span12 block-no-review">
                                                                                <div class="span9">
                                                                                    <span style="color: #999999;margin-left: -20px;">Chưa
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide21" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php" tabindex="-1">Chỉnh css cho
                                                                                    website</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12" style="margin: 0;padding-left: 20px">
                                                                                ...
                                                                                <div class="span9">
                                                                                    <div>
                                                                                        ...
                                                                                        <div class="client-name" style="margin-top: 8px">
                                                                                            ...
                                                                                            <span style="margin-left: 5px">Trần
                                                                                                Hữu Hiếu</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="span9">
                                                                                    <div>
                                                                                        ...
                                                                                        <div class="client-name" style="margin-top: 8px">
                                                                                            ...
                                                                                            <span style="margin-left: 5px">Steven
                                                                                                Cao</span>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="span3">
                                                                                    ...
                                                                                    <span class="rating_pf">
                                                                                        <div class="rating-box num_star_rating" style="float:right" data-toggle="popover" data-placement="bottom" data-content="3,4" data-trigger="hover">
                                                                                            <div class="rating" style="width:68.0%">
                                                                                            </div>
                                                                                        </div>
                                                                                    </span>
                                                                                </div>
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="6" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide26" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php" tabindex="-1">Cài đặt Windows VPS và
                                                                                    cài phần mềm k�...</a>
                                                                            </h3>
                                                                        </div>
                                                                        <div class="span12" style="margin: 0;padding-left: 20px">
                                                            ...
                                                            <div class="sublist-item slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide30" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/Freelancer/detailJob.php" tabindex="0">Fix và bổ sung thêm
                                                            ...
                                                            <div class="sublist-item slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide31" style="width: 743px;">
                                                                <div class="job-item">
                                                                    <div class="row-fluid">
                                                                        <div class="job-comment span12">
                                                                            <h3 class="title">
                                                                                <a href="/viec-freelance/lap-trinh-front-end-cho-asp-net-webform-voi-html-jquery-va-bootstrap" tabindex="-1">Lập trình front end
                    ...
                    <div class="summary-profile contact-direct contact-mobile">
                        ...
                        <div class="list-summary-profile row-fluid">
                            ...
                            <dl class="dl-horizontal span7">
                                <dd><a class="__cf_email__" data-cfemail="2f424641474240411e1e1d1d1c1c6f48424e4643014c4042">minhmon112233@gmail.com</a>
                                </dd>
                            </dl>
                        </div>
                        <div class="list-summary-profile row-fluid">
