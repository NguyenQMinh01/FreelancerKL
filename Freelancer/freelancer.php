...
<head>
    ...
    <meta property="og:description" itemprop="description" name="description"
        content="Thuê freelancer lập trình, thiết kế, marketing, viết lách, dịch thuật, v.v. trên toàn Việt Nam với giá hợp lý, giúp tiết kiệm 50% chi phí cho doanh nghiệp." />
    ...
    (function() {
        ...
        font.type = 'text/css';
        font.rel = 'stylesheet';
        font.href = 'https://www.vlance.vn/css/vlance_homepage.css?v=20221103.1449';
    ...
    <script type="text/javascript" src="https://www.vlance.vn/js/slider_home/jquery.eislideshow.min.js?v=20221103.1449"
        defer></script>
    <script type="text/javascript" src="https://www.vlance.vn/js/slider_home/jquery.easing.1.3.min.js?v=20221103.1449"
        defer></script>
                                                    ...
                                                    <li class="menu-dropdown-content-item">
                                                        ...
                                                        <ul class="content-item-detail">
                                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                    ...
                                                                    freelancer</a></li>
                                                            <li role="presentation"><a role="menuitem" tabindex="-1"
                                                                    href="/Freelancer/profilefreelancer.php">Sản phẩm đã
                                                                    làm</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                    ...
                    <ul class="nav-menu span12">
                        <li class="tf200 ">
                            <div class="dropdown manage-user">
                                <a href="#" data-toggle="dropdown"> Quản lý cho freelancer <i class="fa fa-angle-down"
        ...
        <div class="navbar navbar-static-top nav-new display-mobile ver2">
            ...
            <div class="overlay-block overlay-left login ver2" style="height: 800px;display: none">
                <div class="close-button">
                    <a><i><img style="width: 18px; height: 18px;"
                                src="https://www.vlance.vn/img/close_icon.svg" /></i></a>
                </div>
                        ...
                        <li class="accordion-chevron menu-mobile-item ver2">
                            <ul class="submenu-list-ver2 accordion-menu-dropdown ">
                                <li class="submenu-item-ver2 accordion-chevron">
                                    ...
                                    <a class="submenu-link-ver2 accordion-toggle-ver2 ver2" href="/j-s/freelancer">Quản
                        ...
                        <li class="accordion-chevron menu-mobile-item ver2">
                            ...
                            <ul class="submenu-list-ver2 accordion-menu-dropdown">
                                ...
                                <li class="submenu-item-ver2 accordion-chevron">
                                    ...
                                    <ul class="accordion-inner-ver2">
                                        <li class="ver2">
                                            <a role="menuitem" tabindex="-1" href="/viec-lam-freelance"
                                                onclick="vtrack('Click job list page', {'position':'Homepage'})">Việc
                                                online</a>
                                        </li>
                                        <li class="ver2">
                                            <a role="menuitem" tabindex="-1" href="/cuoc-thi-thiet-ke"
                                                onclick="vtrack('Click contest list page', {'position':'Homepage'})">Cuộc
                                                thi thiết kế</a>
                                        </li>
                                        <li class="ver2">
                                            <a role="menuitem" tabindex="-1" href="/viec-lam-toan-thoi-gian"
                                                onclick="vtrack('Click fulltime job list page', {'position':'Homepage'})">Việc
                                                full-time</a>
                                        </li>
                                    </ul>
...
>>>>>>> 2389e9d ([fixGUI] fix gui profilefreelan add quanliviec)
                            ...
                            <ul class="submenu-list-ver2 accordion-menu-dropdown">
                                <li class="submenu-item-ver2 accordion-chevron">
                                    <a class="submenu-link-ver2 ver2"
                                        href="/doanh-nghiep?utm_campaign=VBcam1-TOPN-20220607&utm_source=vl-homepage&utm_medium=top-nav&utm_content=button">Trang
                                        chủ Business</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-mobile-item ver2 img-500k">
                            <a style="width: 100px; height: 29px" href="/a/moi-ban-be"
                                onclick="vtrack('Click invite', {'location':'vlance_homepage'})">
            ...
            <div class="homepage-new">
                    ...
                    <div class="carousel-inner">
                            ...
                            <header class="jumbotron-new carousel-subhead_1">
                                <div class="container">
                                    <div class="jumbotron-new-even">
                                        <h1 class="lh8 mp-lh6"><b>Đảm bảo hoàn thành dự án</b> với freelancer hàng đầu
                                        </h1>
                                        <div class="jumbotron-button">
                                            <a style="background-color:transparent"
                                                class="btn btn-vl btn-vl-special btn-vl-green"
                                                onclick="vtrack('Click post job', {'position':'Homepage'})"
                                                title="Đăng báo giá ngay">Cam kết uy tín</a>
                                        </div>
                            ...
                            <header class="jumbotron-new carousel-subhead_2">
                                <div class="container">
                                    <div class="jumbotron-new-even">
                                        ...
                                        <div class="jumbotron-button">
                                            <a style="background-color:transparent"
                                                class="btn btn-vl btn-vl-orange btn-vl-special"
                                                onclick="vtrack('Click contest job', {'position':'Homepage'})"
                                                title="Tạo cuộc thi mới">Có nhiều cuộc thi mới</a>
                                        </div>
                                        <div class="jumbotron-new-content">
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <p class="step-job">3</p>
                                                    <p>Chọn mẫu đẹp nhất và thanh toán</p>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="item">
                            <header class="jumbotron-new carousel-subhead_3">
                                <div class="container">
                                    <div class="jumbotron-new-even">
                                        <h1 class="lh8 mp-lh6">Dịch vụ Marketing, Thiết kế trọn gói chỉ từ
                                            <b>200.000</b> <i>₫</i>
                                        </h1>
                                        <div class="jumbotron-button">
                                            <a style="background-color:transparent" rel="nofollow"
                                                class="btn btn-vl btn-vl-blue btn-vl-special"
                                                onclick="vtrack('Click Thuengay banner', {'position':'Homepage'})"
                                                target="_blank" title="Xem tất cả dịch vụ">Có nhiều dịch vụ</a>
                                        </div>
                                        <div class="jumbotron-new-content">
                                            <ul>
                                                <li>
                                                    <p class="step-job">1</p>
                                                    <p>Chọn dịch vụ <br />& Đặt hàng</p>
                                                </li>
                                                <li class="angle-right">
                                                    <i class="fa fa-angle-right"></i>
                                                </li>
                                                <li>
                                                    <p class="step-job">2</p>
                                                    <span>Làm việc nhanh chóng</span>
                                                </li>
                                                <li class="angle-right">
                                                    <i class="fa fa-angle-right"></i>
                                                </li>
                        ...
                        <header class="jumbotron-new carousel-subhead_1">
                            <div class="container">
                                <div class="jumbotron-new-even">
                                    ...
                                    <div class="jumbotron-button">
                                        <a class="btn btn-vl btn-vl-small btn-vl-green"
                                            onclick="vtrack('Click post job', {'position':'Homepage'})" href=""
                                            title="Đăng dự án ngay">Đăng báo giá ngay</a>
                                    </div>
                                </div>
                            </div>
                        </header>
                        ...
                        <header class="jumbotron-new carousel-subhead_2">
                            <div class="container">
                                <div class="jumbotron-new-even">
                                    ...
                                    <div class="jumbotron-button">
                                        <a class="btn btn-vl btn-vl-orange btn-vl-small"
                                            onclick="vtrack('Click contest job', {'position':'Homepage'})" href="#"
                                            title="Tạo cuộc thi mới">Tạo cuộc thi mới</a>
                                    </div>
                                </div>
                            </div>
                        </header>
                        ...
                        <header class="jumbotron-new carousel-subhead_3">
                            <div class="container">
                                <div class="jumbotron-new-even">
                                    ...
                                    <div class="jumbotron-button">
                                        <a rel="nofollow" class="btn btn-vl btn-vl-blue btn-vl-small"
                                            onclick="vtrack('Click contest job', {'position':'Homepage'})" href=""
                                            target="_blink" title="Xem tất cả dịch vụ">Xem tất cả dịch vụ</a>
                                    </div>
                                </div>
                            </div>
                        </header>
                ...
                <div class="list-job-homepage">
                    ...
                    <div class="v1_568">
                        ...
                        <div class="v1_633"><span class="v1_634">Đăng dự án miễn phí </span><span class="v1_635">Bạn sẽ
                                có cơ hội nhận tiền thưởng lên đến 50 triệu khi giới thiệu ứng viên chất lượng cho chúng
                                tôi. Chương trình không giới hạn số lượng giới thiệu cho từng vị trí,
                                cũng như không giới hạn tổng số tiền thưởng bạn có thể nhận được từ việc giới thiệu ứng
                                viên.
                    ...
                    <div class="job"
                        style="text-align: left;max-width: 910px;margin-left: auto;margin-right: auto;background: #ffffff;border: 1px solid #CCCCCC;">
                        <div style="overflow: hidden" class="row-fluid vlance-hompage-listjob row-result ">
                            <div class="fr-info span12">
                                        ...
                                        <div class="fr-title">
                                            <div id="client-rating-box" class="list-job-rating">
                                                <div class="box-rating-client" data-toggle="popover"
                                                    ...
                                                    data-content="<div>Tiền đã thuê : <b>0</b> VNĐ</div><div>Việc đã đăng : <b>1</b> việc</div><div>Việc đã giao : <b>0</b> việc</div>"
                                ...
                                <div class="fr-summary row-fluid fr-summary-desktop">
                                    <div class="history span8" style="min-height: initial;padding: 10px 10px 9px">
                                        ...
                                        <span class="history-job hidejs" style="display:none">
                                            15.000.000 đ - 20.000.000 đ </span>
                                    </div>
                                    <div class="span4 remain-job hidejs"
                                        style="display:none;min-height: initial;padding: 10px 10px 9px;text-align: right">
                                        <div class="remain">
                                            Hạn nhận hồ sơ: 8 ngày 15 giờ </div>
                                    </div>
                                </div>
                                <div class="fr-summary row-fluid fr-summary-mobile">
                                    <div class="history">
                                        <span class="separator hidejs"
                                            style="display:none; color: #999999;margin-right: 9px">Ngân sách dự
                                            kiến</span>
                                        <span class="history-job hidejs" style="display:none">
                                            15.000.000 đ - 20.000.000 đ </span>
                                    </div>
                                    <div class="remain-job hidejs" style="display:none">
                                        <div class="remain">
                                            <span style="color: #999999;margin-right: 25px">Hạn nhận hồ sơ</span> 8 ngày
                                            15 giờ
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="fr-service fr-service-desktop">
                                    Thiết kế một website b&aacute;n h&agrave;ng to&agrave;n diện, bao gồm c&aacute;c
                                    giao diện cần thiết: listing sản phẩm, giỏ h&agrave;ng, check out, gợi &yacute; sản
                                    phẩm, scan m&atilde; code,&hellip;
                                    ...
                                    <div class="skill-list span8 row-fluid">
                                        ...
                                        <span>
                                            <a href="#" title="Việc freelance Tiếng Anh">
                                                Tiếng Anh </a>
                                            <a href="#" title="Việc freelance B&aacute;n h&agrave;ng">
                                                B&aacute;n h&agrave;ng </a>
                                            <a href="#" title="Việc freelance Thiết kế giao diện">
                                                Thiết kế giao diện </a>
                                            <a href="#" title="Việc freelance code">
                                                code </a>
                                        </span>
                                    </div>
                                    <div class="span4">
                            ...
                            <div class="fr-info span12">
                                <div style="overflow: hidden">
                                    <div class="span10">
                                        <h3 class="fr-name block-title">
                                            <a href="/Freelancer/detailJob.php">
                                                Remote/parttime Hỗ trợ ph&aacute;t triển, cập nhật nội dung l&ecirc;n
                                                website </a>
                                ...
                                <div class="fr-summary row-fluid fr-summary-mobile">
                                    ...
                                    <div class="remain-job hidejs" style="display:none">
                                        <div class="remain">
                                            <span style="color: #999999;margin-right: 25px">Hạn nhận hồ sơ</span> 9 ngày
                                            23 giờ
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="fr-service fr-service-desktop">
                                    m&igrave;nh cần 1 bạn l&agrave;m remote để ph&aacute;t triển, cập nhật nội dung
                                    l&ecirc;n website tmđt vmedi.com.vn. Chỉnh sửa, update v&agrave; ph&aacute;t triển
                                    th&ecirc;m những thứ linh tinh. <a class="read_more" href="#">
                                        Xem thêm </a>
                                </div>
                                <div class="fr-service fr-service-mobile">
                                    m&igrave;nh cần 1 bạn l&agrave;m remote để ph&aacute;t triển, cập nhật nội dung
                                    l&ecirc;n website tmđt... <a class="read_more" href="#">
                                        Xem thêm </a>
                                </div>
                                <div class="fr-profile row-fluid">
                                    <div class="skill-list span8 row-fluid">
                        ...
                        <div style="overflow: hidden" class="row-fluid vlance-hompage-listjob row-result ">
                            <div class="fr-info span12">
                                <div style="overflow: hidden">
                                    <div class="span10">
                                        ...
                                        <div class="fr-title">
                                            ...
                                            <a style="color: #000" href="#" title="Dong Le">
                                                <span>Dong Le </span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="fr-service fr-service-desktop">
                                    Tuyển 1 Nữ CTV chuy&ecirc;n viết b&agrave;i cho website, dịch thuật từ b&agrave;i
                                    tiếng Anh qua tiếng việt, nếu dịch được từ Việt -&gt; Anh c&agrave;ng tốt.
                                    B&agrave;i viết chuẩn SEO c&agrave;ng tốt.
                                    Website lĩnh vực: Blockchain, đầu tư, b&agrave;i... <a class="read_more" href="#">
                                        Xem thêm </a>
                                </div>
                                <div class="fr-service fr-service-mobile">
                                    Tuyển 1 Nữ CTV chuy&ecirc;n viết b&agrave;i cho website, dịch thuật từ b&agrave;i
                                    tiếng Anh qua... <a class="read_more" href="#">
                                        Xem thêm </a>
                                </div>
                                <div class="fr-profile row-fluid">
                                    <div class="skill-list span8 row-fluid">
                                        <span class="service-tag">
                                            <a href="#" title='Dịch vụ: "Viết nội dung cho website"'>
                ...
                <div class="step-explain-section" style="background-color:#ffffff">
                    <div class="v1_248">
                        ...
                        <div class="name"></div>
                        <div class="v1_251"><span class="v1_252">Đăng dự án</span><span class="v1_253">Nó là miễn phí và
                                dễ dàng để đăng một công việc. Chỉ cần điền tiêu đề,
                                mô tả và ngân sách và giá thầu cạnh tranh sẽ đến trong vòng vài phút.</span><span
                                class="v1_254">Chọn freelancers</span><span class="v1_255">Không có công việc nào là quá
                                lớn hay quá nhỏ. Chúng tôi có các dịch giả tự do cho các công việc thuộc mọi quy mô hoặc
                                ngân sách,
                                với hơn 1800 kỹ năng.
                            </span><span class="v1_256">Thanh toán an toàn</span><span class="v1_257">Chỉ thanh toán cho
                                công việc khi nó đã được hoàn thành và bạn hài lòng 100% với chất lượng bằng cách sử
                                dụng hệ thống thanh toán quan trọng của chúng tôi.</span>
                            <div class="v1_258"></div>
                            <div class="v1_259"></div>
                            <div class="v1_260"></div><span class="v1_261">03</span>
                            <div class="v1_262"></div><span class="v1_263">04</span><span class="v1_264">Chúng tôi ở đây
                                để giúp đỡ</span><span class="v1_265">Đội ngũ tuyển dụng tài năng của chúng tôi có thể
                                giúp bạn tìm được người làm việc tự do tốt nhất cho công việc và các cộng sự kỹ thuật
                                của chúng tôi.
                ...
                <div class="professional-apply-section layzy" data-background="/img/homepage-new/bg_homepage_03.jpg">
                    <div class="container">
                        <h3 class="title lh8 mp-lh6">
                            Bạn có trên <span>3 năm kinh nghiệm</span> Và muốn tìm việc để <span>tăng thu nhập?</span>
                        </h3>
                        <div class="professional-apply-button">
                            <a class="btn btn-vl btn-vl-special btn-vl-green" title="link_img_vnen.home_page.title_4"
                                href="/a/register/freelancer">Đăng ký làm chuyên gia</a>
                        </div>
                    </div>
                </div>
                <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                a.data.map((v, i) => {
                    s += ` <div style="overflow: hidden" data-id=${v.id_job} class="row-fluid vlance-hompage-listjob row-result listjob">
                            <div class="fr-info span12">
                                <div style="overflow: hidden">
                                    <div class="span10">
                                        <h3 class="fr-name block-title">
                                            <a data-id=${v.id_job} class="detailjob">
                                                ${v.title} 
                                            </a>
                                        </h3>
                                        <div class="fr-title">
                                ...
                                <div class="fr-summary row-fluid fr-summary-desktop">
                                    <div class="history span8" style="min-height: initial;padding: 10px 10px 9px">
                                        ...
                                        <span class="separator">|</span>
                                        <span class="category">
                                            ${v.skill_request?v.skill_request:"Không yêu cầu"} 
                                        </span>
                                    </div>
                                </div>
